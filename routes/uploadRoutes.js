...
// Signature routes
router.post('/upload', upload.single('image'), isAdminAuthenticated, uploadImage);
router.delete('/delete/:public_id(*)', isAdminAuthenticated, deleteImage);
router.get('/list', isAdminAuthenticated, getImages);
router.put('/edit/:public_id(*)', upload.single('image'), isAdminAuthenticated, editImage);

// File routes
router.post('/file-upload', fileUpload.single('file'), isAdminAuthenticated, uploadFile);
router.delete('/delete-file/:public_id(*)', isAdminAuthenticated, deleteFile);
router.get('/list-files', isAdminAuthenticated, getFiles);
router.put('/edit-file/:public_id(*)', fileUpload.single('file'), isAdminAuthenticated, editFile);
